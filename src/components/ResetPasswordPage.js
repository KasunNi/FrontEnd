...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch(`http://localhost:3001/api/customer/reset-password`, resetData) // Update the API endpoint based on the actual backend routes
      .then(() => {
        // Handle successful password reset
        history.push('/customer/login'); // Redirect to the customer login page
      })
      .catch((error) => {
