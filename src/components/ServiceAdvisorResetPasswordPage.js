...
const ServiceAdvisorResetPasswordPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch(`http://localhost:3001/api/service-advisor/reset-password`, resetData) // Update the API endpoint based on the actual backend routes
      .then(() => {
        // Handle successful password reset
        history.push('/service-advisor/login'); // Redirect to the service-advisor login page
      })
      .catch((error) => {
  ...
  return (
    <div className="login-container">
      ...
      <h2>Reset Password(Service Advisor)</h2>
...
export default ServiceAdvisorResetPasswordPage;
