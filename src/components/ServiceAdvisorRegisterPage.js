...
const RegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post('http://localhost:3001/api/service-advisor/register', userData) // Update the API endpoint based on the actual backend routes
      .then(() => {
        // Handle successful registration
        history.push('/admin/dashboard'); // Redirect to the service-advisor login page
      })
      .catch((error) => {
  ...
  return (
    <div className="login-container">
      ...
      <h2>Service Advisor Register</h2>
